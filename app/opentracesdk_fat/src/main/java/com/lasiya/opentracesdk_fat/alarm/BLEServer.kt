...
import com.lasiya.opentracesdk_fat.BLETrace.getAlarmManager
import com.lasiya.opentracesdk_fat.util.Constants.BACKGROUND_TRACE_INTERVAL
...
class BLEServer : BroadcastReceiver(), GattServerActionListener  {
    ...
    private val WAKELOCK_TAG = "com:lasiya:breach:worker:BLEServer"
