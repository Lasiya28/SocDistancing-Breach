...
import com.lasiya.opentracesdk_fat.R
...
object NotificationUtils {
    ...
    const val ACTION_TOO_CLOSE_NOTIFICATION =
        "com.lasiya.breach.ACTION_TOO_CLOSE_NOTIFICATION"

    const val ACTION_DANGER_NOTIFICATION =
        "com.lasiya.breach.ACTION_DANGER_NOTIFICATION"
    ...
    private fun getNotificationBuilderTooClose(): NotificationCompat.Builder {
        ...
        val notificationIntent = Intent(context, Class.forName("com.lasiya.breach.MainActivity"))
