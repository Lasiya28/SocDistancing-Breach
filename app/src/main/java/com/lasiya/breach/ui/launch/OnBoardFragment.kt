package com.lasiya.breach.ui.launch

import com.lasiya.breach.R
import com.lasiya.breach.util.Constants
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        when (args.screen) {
            ONBOARD_ONE -> {
                ...
                view.findViewById<ImageView>(R.id.section_img).background = resources.getDrawable(R.drawable.istockphoto_1214510906_612x612, null)
